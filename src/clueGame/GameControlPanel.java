...
public class GameControlPanel extends JPanel {
    ...
    //private String playerName = "First Player", guess = "First guess", guessResult = "First guess result";
    private int roll;
    ...
    public GameControlPanel() {
        ...
        labelGuessResult.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Guess Result"));
